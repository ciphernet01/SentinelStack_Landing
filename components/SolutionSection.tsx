...
const SolutionSection: React.FC = () => {
  ...
  // Function to color code terminal lines - WITH ERROR HANDLING
  ...
  // Safe line rendering function
  const renderTerminalLine = (line: string | undefined, index: number) => {
    if (!line) return null;
    
    const colorClass = getLineColor(line);
    
    if (line.startsWith('admin@sentinel-blade')) {
